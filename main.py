...
def main(args, tool):
    ...
    for cnt in contours:
        ...
        if approx.shape[0] == 4:
            ...
            # BRAND
            # BRAND_x_left = int(14.5 / design_w_plate * w_plate + 0.5)
            # BRAND_x_right = int(50.5 / design_w_plate * w_plate + 0.5)
            # BRAND_y_up = int(1 / design_h_plate * h_plate + 0.5)
            # BRAND_y_down = int(5 / design_h_plate * h_plate + 0.5)
            BRAND_x_left = 90
            BRAND_x_right = 325
            BRAND_y_up = 8
            BRAND_y_down = 47
            ...
            # COUNTRY
            # COUNTRY_x_left = int(66.5 / design_w_plate * w_plate + 0.5)
            # COUNTRY_x_right = int(88 / design_w_plate * w_plate + 0.5)
            # COUNTRY_y_up = int(1 / design_h_plate * h_plate + 0.5)
            # COUNTRY_y_down = int(5 / design_h_plate * h_plate + 0.5)
            COUNTRY_x_left = 440
            COUNTRY_x_right = 615
            COUNTRY_y_up = 1
            COUNTRY_y_down = 50
            ...
            # TYPE
            # TYPE_x_left = int(20.5 / design_w_plate * w_plate + 0.5)
            # TYPE_x_right = int(36.4 / design_w_plate * w_plate + 0.5)
            # TYPE_y_up = int(6 / design_h_plate * h_plate + 0.5)
            # TYPE_y_down = int(10 / design_h_plate * h_plate + 0.5)
            TYPE_x_left = 120
            TYPE_x_right = 260
            TYPE_y_up = 40
            TYPE_y_down = 90
            ...
            # NUMBER
            # NUMBER_x_left = int(20.5 / design_w_plate * w_plate + 0.5)
            # NUMBER_x_right = int(36.4 / design_w_plate * w_plate + 0.5)
            # NUMBER_y_up = int(6 / design_h_plate * h_plate + 0.5)
            # NUMBER_y_down = int(10 / design_h_plate * h_plate + 0.5)
            NUMBER_x_left = 120
            NUMBER_x_right = 440
            NUMBER_y_up = 80
            NUMBER_y_down = 130
            ...
            # OCCUPANTS
            OCCUPANTS_x_left = 510
            OCCUPANTS_x_right = 545
            OCCUPANTS_y_up = 155
            OCCUPANTS_y_down = 210
            ...
            # MANUFACTURER
            MANUFACTURER_x_left = 135
            MANUFACTURER_x_right = 500
            MANUFACTURER_y_up = 270
            MANUFACTURER_y_down = 330
            ...
            # MANUFACTURERn1
            MANUFACTURERn1_x_left = 130
            MANUFACTURERn1_x_right = 390
            MANUFACTURERn1_y_up = 310
            MANUFACTURERn1_y_down = 370
            ...
            # MANUFACTURERn2
            MANUFACTURERn2_x_left = 125
            MANUFACTURERn2_x_right = 345
            MANUFACTURERn2_y_up = 355
            MANUFACTURERn2_y_down = 410
